(function(root,factory){
  ...
  const drinks=[
    ...
    drink('d4','Spiced Saison','Beer',['Spicy','Fresh'],14),
    ...
    drink('d8','Market Mule','Vodka',['Fresh','Spicy'],14),
    ...
    drink('d16','Smoked Manhattan','Whiskey',['Premium','Bitter'],22),
    ...
    drink('d29','Pepper Negroni','Gin',['Bitter','Spicy'],18),
    ...
    drink('d36','Platinum Añejo','Tequila',['Premium'],22),
    drink('d37','Velvet Merlot','Wine',['Fruity','Savory'],16),
    drink('d38','City Spritz','Wine',['Fresh','Clean'],14),
    drink('d39','Golden Sangria','Wine',['Cheap','Fruity'],14),
    drink('d40','Cellar Select','Wine',['Premium','Savory'],20),
  ...
  return{schemaVersion:'0.5.8',spirits,styles,drinks,customers,bartenders,starterIds};
});
